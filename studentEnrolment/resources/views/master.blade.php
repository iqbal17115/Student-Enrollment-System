  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{ URL::to('admin/adminDashboard') }}"><img src="images/salt_logo.svg" alt="Logo"></a>
      </div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <div class="details">
              <p class="user-name">Md Iqbal Hossain</p>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ URL::to('admin/allStudent') }}">
                <i class="mdi mdi-gauge menu-icon"></i>
                <span class="menu-title">All Student</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ URL::to('admin/addStudent') }}">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ URL::to('admin/cse') }}">CSE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ URL::to('admin/bba') }}">BBA</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ URL::to('admin/ece') }}">ECE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ URL::to('admin/eee') }}">EEE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ URL::to('admin/mba') }}">MBA</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="advancedSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ URL::to('admin/allTeacher') }}">All Teacher</a>
                  </li>
                  <li class="nav-item">
              <a class="nav-link" href="{{ URL::to('admin/addTeacher') }}">Add Teacher</a>
                  </li>
                </ul>
              </div>
            </li>
