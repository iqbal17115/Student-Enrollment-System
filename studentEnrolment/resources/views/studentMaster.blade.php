  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{ URL::to('student/studentDashboard') }}"><img src="images/salt_logo.svg" alt="Student"></a>
      </div>
        ...
        <ul class="navbar-nav ml-lg-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown mail-notification" aria-labelledby="MailDropdown">
              ...
              <a class="dropdown-item" href="{{ URL::to('student/setting') }}">
                <div class="sender-img">
                  <span class="badge badge-success">&nbsp;</span>
                </div>
                <div class="sender">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            <div class="profile">
              ...
              ?>
              <img src="{{ Storage::url($update->image) }}" alt="">
            </div>
            <div class="details">
              <p class="user-name">{{ strtoupper($update->name) }}</p>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ URL::to('student/setting') }}">
                <i class="mdi mdi-gauge menu-icon"></i>
